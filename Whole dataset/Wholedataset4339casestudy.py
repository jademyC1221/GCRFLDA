...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 15 08:17:00 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 06:35:37 2021
...
filename='wholeset4339casestudy.xlsx'
...
###  Save
#import pickle
#output = open('wholesetcasestudy_4339.pkl','wb')
#'''28,37;200,0.5,0.001'''
...
###  Read
##import pickle
#pkl_file=open('wholesetcasestudy_4339.pkl','rb')
#'''28,37;200,0.5,0.001'''
...
###  Save
import pickle
output = open('wholesetcasestudy_4339_2837.pkl','wb')
'''28,37;240,0.5,0.001'''
pickle.dump(edge_df,output)
pickle.dump(pred_y0,output)
pickle.dump(prob0,output)
