...
#                    print('test on....................iii=%d' % (iii))
            ...
            namepkl = 'Para_wholeset4339_2837'+'epoch'+str(EPOCHS)+'drop'+str(DROPOUT_RATIO)+'lr'+str(LEARNING_RATE)+'.pkl'
            PKL.append(namepkl)
...
# #读取数据
#import pickle
#pkl_file=open('Para_wholeset4339_2837epoch200drop0.5lr0.001'+str(iii)+'.pkl','rb')
