[~,lncname]=xlsread('associationLNSUBRW.xlsx','Sheet2');  
[~,disname]=xlsread('associationLNSUBRW.xlsx','Sheet3');  
[~,association]=xlsread('associationLNSUBRW.xlsx','Sheet1'); 
load LNSUBRWmatrix;
lncrnaDisease = LNSUBRWmatrix;
% r lncid, c disid
...
xlswrite('Dataset3casestudy.xlsx',edge_f1,'Sheet 1');
fprintf('dataset3 finish!\n');


% casestudy result
clear;
predY =xlsread('predYDataset3.xlsx');
[~,lncname]=xlsread('associationLNSUBRW.xlsx','Sheet2');  
[~,disname]=xlsread('associationLNSUBRW.xlsx','Sheet3');  
length(predY);
Disname = [];
...
[~,lncrna] = xlsread('./dataset3.xlsx','Sheet1');
