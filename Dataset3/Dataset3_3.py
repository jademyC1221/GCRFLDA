# -*- coding: utf-8 -*-
"""
Created on Fri Feb 19 13:45:05 2021
...
for iii in range(0,2,1):   
    ...
    lncfilename="lnsubrw_lncsim"+lncweit[iii]
    disfilename="lnsubrw_dissim"+disweit[iii]
    ...
    for ii in range(0,7,1):
        for jj in range(0,2,1):
            ...
            #                test_acc_history.append(test_accitem)
                ...
                #保存数据
#                import pickle
                output = open('LNSUBRW'+str(iii)+'epoch'+str(EPOCHS)+'drop'+str(DROPOUT_RATIO)+'lr'+str(LEARNING_RATE)+'.pkl','wb')
...
#import pickle
#output = open('LNSUBRW_para.pkl','wb')
...
#读取数据
import pickle
pkl_file=open('LNSUBRW_para.pkl','rb')
