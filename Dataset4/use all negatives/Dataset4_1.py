# -*- coding: utf-8 -*-
"""
Created on Fri Feb 19 14:06:09 2021
...
##
#
#filename='/home/lsz/GraphNeuralNetwork-master/LDNFSGB/LDNFSGB_cv10_1.xlsx'
...
#
#Label=[labels,labels2,labels3,labels4,labels5,labels6,labels7,labels8,labels9,labels10]
#
#Tramask=[train_mask,train_mask2,train_mask3,train_mask4,train_mask5,train_mask6,train_mask7,train_mask8,train_mask9,train_mask10]
#
#Testmask=[test_mask,test_mask2,test_mask3,test_mask4,test_mask5,test_mask6,test_mask7,test_mask8,test_mask9,test_mask10]
#
##
##保存数据
#import pickle
#output = open('LDNFSGBcase10cv.pkl','wb')
