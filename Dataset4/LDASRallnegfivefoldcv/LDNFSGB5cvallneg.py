...
# -*- coding: utf-8 -*-
"""
Created on Fri May  7 06:00:30 2021
...
##    j=1
#filename='LDNFSGB_5cvallneg_1.xlsx'
...
##保存数据
#import pickle
#output = open('LDNFSGB5cvallnegdata.pkl','wb')
...
#        #保存数据
##        import pickle
#        output = open('LDNFSGB5cvallneg_weightzuhe.pkl','wb')
...
#读取数据
import pickle
pkl_file=open('LDNFSGB5cvallneg_weightzuhe.pkl','rb')
