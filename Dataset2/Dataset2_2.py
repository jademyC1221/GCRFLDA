# -*- coding: utf-8 -*-
"""
Created on Fri Feb 19 12:55:28 2021
...
for iii in range(0,2,1):   
    ...
    lncfilename="dmflda_lncsim"+lncweit[iii]
    disfilename="dmflda_dissim"+disweit[iii]
    ...
    for ii in range(0,7,1):
        for jj in range(0,2,1):
            ...
            #                test_acc_history.append(test_accitem)
                ...
                #保存数据
#                import pickle
                output = open('DMFLDA'+str(iii)+'epoch'+str(EPOCHS)+'drop'+str(DROPOUT_RATIO)+'lr'+str(LEARNING_RATE)+'.pkl','wb')
...
import pickle
output = open('DMFLDA_para.pkl','wb')
...
# #读取数据
# import pickle
# pkl_file=open('DMFLDA_para.pkl','rb')
